...
EXPORT_SYMBOL(have_governor_per_policy);

bool cpufreq_driver_is_slow(void)
{
	return !(cpufreq_driver->flags & CPUFREQ_DRIVER_FAST);
}
EXPORT_SYMBOL(cpufreq_driver_is_slow);
...
EXPORT_SYMBOL(get_governor_parent_kobj);
...
EXPORT_SYMBOL(cpufreq_generic_init);
...
EXPORT_SYMBOL(cpufreq_generic_get);
...
EXPORT_SYMBOL(cpufreq_freq_transition_begin);
...
EXPORT_SYMBOL(cpufreq_freq_transition_end);
...
EXPORT_SYMBOL(cpufreq_show_cpus);
...
EXPORT_SYMBOL(cpufreq_get_driver_data);
...
EXPORT_SYMBOL(cpufreq_boost_supported);
...
EXPORT_SYMBOL(cpufreq_enable_boost_support);

int cpufreq_boost_enabled(void)
{
	return cpufreq_driver->boost_enabled;
}
EXPORT_SYMBOL(cpufreq_boost_enabled);
